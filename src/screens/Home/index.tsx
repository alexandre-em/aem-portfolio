...
const imageStyle = {
  ...
  borderRadius: 5,
  boxShadow:
    "rgba(255, 255, 255, 0.05) 0px 1px 1px 0px inset, rgba(50, 50, 93, 0.15) 0px 50px 100px -20px, rgba(0, 0, 0, 0.2) 0px 30px 60px -30px",
};
const resumeLink = `https://drive.google.com/file/d/1yiToT9R1EXYW18tS5wx3KMM2ZFhmPu86/view?usp=sharing`;

export default function Home() {
  const skills = ["ReactJs", "React Native", "NextJs", "NodeJs", "Java Spring"];
  ...
  return (
    <Main>
      <About>
        <AboutText>
          ...
          <div>
            <Button variant="outlined" sx={{ marginX: 2 }}>
              <a
                href={resumeLink}
                style={{ textDecoration: "none", color: blueGrey[500] }}
              >
                My Resume
              </a>
            </Button>
        ...
        <AboutImage>
          <img
            src={require("./images/clement-helardot-95YRwf6CNw8-unsplash.jpg")}
            loading="lazy"
            width="50%"
            style={imageStyle}
            alt=""
